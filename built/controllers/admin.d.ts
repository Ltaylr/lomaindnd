export function getHome(req: any, res: any, next: any): void;
export function getAddCampaign(req: any, res: any, next: any): void;
export function postAddCampaign(req: any, res: any, next: any): any;
